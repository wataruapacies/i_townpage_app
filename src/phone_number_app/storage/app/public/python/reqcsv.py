...
what = aaa[1]
where = aaa[2]
sql = "DELETE FROM posts WHERE id = " + str(id_n) + ";"
cursor.execute(sql)
connection.commit()
cursor.close()
...
csv_file_name2 = '/var/www/html/phone_number_app/storage/app/public/python/log/' + box_search_what + '_' + box_search_where + '.csv'
...
while True:
    ...
    if number_p == 0:
        while iii < 10:
            iii = iii + 1
            try:
                xpath = "/html/body/div/div/div[2]/div/div/div/div[2]/div/main/section[3]/div[5]/div[3]/p/span[@class='wixui-rich-text__text']"
    ...
    for i in range(6):
        ...
        while kjk<4:
            ...
            try:
                row = ['','','','','','','']
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[2]/div/div[" + str(i+1) + "]/div[3]/div[2]/div[2]/div[4]/p[@class='font_8']/a"
                soup = BeautifulSoup(res.text,'html.parser')
                xml = etree.HTML(str(soup))
                company_name = xml.xpath(xpath)[0]
                row[0]=company_name.text
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[2]/div/div[" + str(i+1) + "]/div[4]/div[3]/div[3]/p/span[@class='wixui-rich-text__text']"
                ...
                row[1]=phone_ans
                #print(phone_ans)
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[2]/div/div[" + str(i+1) + "]/div[3]/div[3]/div[2]/div[3]/div[2]/p/span"
                company_address = xml.xpath(xpath)[0]
                row[2]=company_address.text
                #print(company_address.text)
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[2]/div/div[" + str(i+1) + "]/div[3]/div[2]/div[2]/div[4]/p[@class='font_8']/a/@href"
...
#                    df = df.append(pandas.Series(row, index=df.columns), ignore_index=True)
    ...
    for i in range(16):
        ...
        while kjk<4:
            ...
            try:
                row = ['','','','','','','']
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[4]/div/div[" + str(i+1) + "]/div[3]/div[2]/div[2]/div[4]/p/a"
                soup = BeautifulSoup(res.text,'html.parser')
                xml = etree.HTML(str(soup))
                company_name = xml.xpath(xpath)[0]
                row[0]=company_name.text
                
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[4]/div/div[" + str(i+1) + "]/div[4]/div[3]/div[3]/p/span"
                company_phone = xml.xpath(xpath)[0]
                phone_number=company_phone.text
                phone_ans = ""
                for jjj in range(len(phone_number)):
                ...
                row[1]=phone_ans
                #print(phone_ans)
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[4]/div/div[" + str(i+1) + "]/div[3]/div[3]/div[2]/div[3]/div[3]/p/span[@class='wixui-rich-text__text']"
                company_address = xml.xpath(xpath)[0]
                row[2]=company_address.text
                #print(company_address.text)
                xpath="/html/body[@class='responsive']/div/div/div[2]/div/div/div/div[2]/div/main/section[1]/div[2]/div[2]/div[2]/div[4]/div/div[" + str(i+1) + "]/div[3]/div[2]/div[2]/div[4]/p/a/@href"
                url_tmp = xml.xpath(xpath)[0]
                #print(url_tmp)
                row[3]=url_tmp
                row[4]=box_search_what
